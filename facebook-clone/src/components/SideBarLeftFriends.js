...
const SideBarLeftFriends = () => {
  return (
    <div className="sideBarLeftFriends">
      {/**============== HEADER ============== */}
      <div className="sideBarLeftFriends__header">
        <h2>Amis</h2>
        <div className="sideBarLeftFriends__header__option">
      ...
      <div className="sideBarLeftFriends__actions">
        ...
        <div className="sideBarLeftFriends__actions__listePerso action">
          <div className="action-img">
            <div className="friendsList svgIn"></div>
          </div>
